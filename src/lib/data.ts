...
export const staticQuestions: { [key: string]: Question[] } = {
  'maths-percentage': Array.from({ length: 10 }, (_, i) => ({
    id: 100 + i,
    question: `If a number is increased by 25%, by what percent must the new number be decreased to get back the original number? (Question ${i + 1})`,
    options: ['20%', '25%', '15%', '30%'],
  ...
  'maths-profit-loss': Array.from({ length: 10 }, (_, i) => ({
    id: 200 + i,
    question: `A shopkeeper sells an item for Rs. 550 at a profit of 10%. What is the cost price? (Question ${i + 1})`,
  ...
  'maths-average': Array.from({ length: 10 }, (_, i) => ({
    id: 300 + i,
    question: `The average of 5 consecutive numbers is 15. What is the largest number? (Question ${i + 1})`,
    options: ['16', '17', '18', '19'],
    correctAnswerIndex: 1,
    subject: 'Maths',
    exam: 'SSC CGL',
  ...
  'maths-si-ci': Array.from({ length: 10 }, (_, i) => ({
    id: 400 + i,
    question: `What is the simple interest on Rs. 1000 for 2 years at 5% per annum? (Question ${i + 1})`,
   ...
   'maths-discount': Array.from({ length: 10 }, (_, i) => ({
    id: 500 + i,
    question: `A shopkeeper gives a 20% discount on an item marked at Rs. 1000. What is the selling price? (Question ${i + 1})`,
  ...
  'maths-boat-stream': Array.from({ length: 10 }, (_, i) => ({
    id: 600 + i,
    question: `A boat goes 10 km upstream in 2 hours. The speed of the stream is 1 km/hr. What is the speed of the boat in still water? (Question ${i + 1})`,
  ...
  'maths-di': Array.from({ length: 10 }, (_, i) => ({
    id: 700 + i,
    question: `The pie chart shows the distribution of expenses. If the total expense is Rs. 1,00,000, what is the expense on food (40%)? (Question ${i + 1})`,
  ...
  'gs': Array.from({ length: 10 }, (_, i) => ({
    id: 800 + i,
    question: `Who is known as the "Father of the Indian Constitution"? (Question ${i + 1})`,
  ...
  'reasoning': Array.from({ length: 10 }, (_, i) => ({
    id: 900 + i,
    question: `If CAT is coded as 3120, what is the code for DOG? (Question ${i + 1})`,
  ...
  'english': Array.from({ length: 10 }, (_, i) => ({
    id: 1000 + i,
    question: `Find the synonym for "Ephemeral". (Question ${i + 1})`,
