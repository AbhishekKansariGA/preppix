...
export const staticQuestions: { [key: string]: Question[] } = {
  ...
  'reasoning': fullTestQuestions([
    ...
    { id: 902, question: 'Find the next term in the following alphanumeric series: Z1A, X2D, V6G, T21J, R88M, P445P, ?', options: ['N2676S', 'N2670S', 'T2676S', 'N2676T'], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: 'निम्नलिखित अल्फ़ान्यूमेरिक श्रृंखला में अगला पद खोजें: Z1A, X2D, V6G, T21J, R88M, P445P, ?', options: ['N2676S', 'N2670S', 'T2676S', 'N2676T'] } },
    { id: 903, question: 'In a code language, ‘SYSTEM’ is written as ‘SYSMET’. How will ‘FRACTION’ be written in that same language, if the logic involves rearranging the letters?', options: ['CARFNOIT', 'CARFTION', 'FRACNOIT', 'CARFNOIT'], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC MTS', translation: { question: 'एक कूट भाषा में, ‘SYSTEM’ को ‘SYSMET’ लिखा जाता है। उसी भाषा में ‘FRACTION’ कैसे लिखा जाएगा, यदि तर्क में अक्षरों को पुनर्व्यवस्थित करना शामिल है?', options: ['CARFNOIT', 'CARFTION', 'FRACNOIT', 'CARFNOIT'] } },
    { id: 904, question: 'A man starts from point A, walks 10 km towards the east, then turns right and walks 5 km. He again turns right and walks 10 km. Finally, he turns to his left and walks 10 km to reach point B. What is the distance and direction of point B from point A?', options: ['15 km South', '10 km North', '15 km West', '20 km East'], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: 'एक व्यक्ति बिंदु A से शुरू होता है, पूर्व की ओर 10 किमी चलता है, फिर दाएं मुड़ता है और 5 किमी चलता है। वह फिर से दाएं मुड़ता है और 10 किमी चलता है। अंत में, वह अपनी बाईं ओर मुड़ता है और बिंदु B तक पहुंचने के लिए 10 किमी चलता है। बिंदु A से बिंदु B की दूरी और दिशा क्या है?', options: ['15 किमी दक्षिण', '10 किमी उत्तर', '15 किमी पश्चिम', '20 किमी पूर्व'] } },
    { id: 905, question: 'Select the option that is related to the third term in the same way as the second term is related to the first term. Doctor : Hospital :: Teacher : ?', options: ['Office', 'School', 'Laboratory', 'Library'], correctAnswerIndex: 1, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: 'उस विकल्प का चयन करें जो तीसरे पद से उसी तरह संबंधित है जैसे दूसरा पद पहले पद से संबंधित है। डॉक्टर : अस्पताल :: शिक्षक : ?', options: ['कार्यालय', 'स्कूल', 'प्रयोगशाला', 'पुस्तकालय'] } },
    ...
    { id: 907, question: 'Arrange the following words in a logical and meaningful order: 1. Application, 2. Selection, 3. Interview, 4. Advertisement, 5. Job Offer. This requires sequencing a process.', options: ['4, 1, 3, 2, 5', '4, 1, 2, 3, 5', '1, 4, 3, 5, 2', '4, 2, 3, 1, 5'], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: 'निम्नलिखित शब्दों को एक तार्किक और सार्थक क्रम में व्यवस्थित करें: 1. आवेदन, 2. चयन, 3. साक्षात्कार, 4. विज्ञापन, 5. नौकरी का प्रस्ताव। इसके लिए एक प्रक्रिया को क्रमबद्ध करने की आवश्यकता है।', options: ['4, 1, 3, 2, 5', '4, 1, 2, 3, 5', '1, 4, 3, 5, 2', '4, 2, 3, 1, 5'] } },
    { id: 908, question: 'Identify the number that completes the series: 3, 7, 16, 35, ?, 153. The pattern involves multiplication and addition.', options: ['74', '78', '84', '88'], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: 'श्रृंखला को पूरा करने वाली संख्या को पहचानें: 3, 7, 16, 35, ?, 153. पैटर्न में गुणा और जोड़ शामिल है।', options: ['74', '78', '84', '88'] } },
    { id: 909, question: 'Among five friends, A is heavier than B. C is lighter than A. D is lighter than B but heavier than E. Who is the heaviest? This is a ranking and ordering problem.', options: ['A', 'B', 'D', 'Cannot be determined'], correctAnswerIndex: 3, subject: 'Reasoning', exam: 'SSC MTS', translation: { question: 'पांच दोस्तों में, A, B से भारी है। C, A से हल्का है। D, B से हल्का है लेकिन E से भारी है। सबसे भारी कौन है? यह एक रैंकिंग और ऑर्डरिंग समस्या है।', options: ['A', 'B', 'D', 'निर्धारित नहीं किया जा सकता'] } },
    ...
    { id: 913, question: "In a secret code, '278' means 'run very fast', '853' means 'come back fast', and '397' means 'run and come'. What is the code for 'back'? This is a decoding problem.", options: ["5", "8", "3", "9"], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: "एक गुप्त कोड में, '278' का अर्थ है 'बहुत तेज दौड़ो', '853' का अर्थ है 'जल्दी वापस आओ', और '397' का अर्थ है 'दौड़ो और आओ'। 'वापस' के लिए कोड क्या है? यह एक डिकोडिंग समस्या है।", options: ["5", "8", "3", "9"] } },
    { id: 914, question: "Find the missing term in the series: B, E, J, Q, ? This pattern is based on the position of letters in the alphabet.", options: ["Z", "A", "Y", "B"], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: "श्रृंखला में लुप्त पद ज्ञात करें: B, E, J, Q, ? यह पैटर्न वर्णमाला में अक्षरों की स्थिति पर आधारित है।", options: ["Z", "A", "Y", "B"] } },
    { id: 915, question: "If 8 * 7 = 30 and 5 * 2 = 14, then based on the same logic, what should 9 * 5 be? The logic is not standard multiplication.", options: ["54", "44", "38", "28"], correctAnswerIndex: 3, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: "यदि 8 * 7 = 30 और 5 * 2 = 14, तो उसी तर्क के आधार पर, 9 * 5 क्या होना चाहिए? तर्क मानक गुणा नहीं है।", options: ["54", "44", "38", "28"] } },
    { id: 916, question: "Analogy: 'Mountain' is to 'Height' as 'River' is to what? This tests the relationship between objects and their properties.", options: ["Water", "Length", "Bank", "Fish"], correctAnswerIndex: 1, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: "सादृश्य: 'पहाड़' का संबंध 'ऊंचाई' से है, वैसे ही 'नदी' का संबंध किससे है? यह वस्तुओं और उनके गुणों के बीच संबंध का परीक्षण करता है।", options: ["पानी", "लंबाई", "किनारा", "मछली"] } },
    { id: 917, question: "A statement is given followed by two assumptions. Statement: 'The government has decided to increase the price of petrol and diesel.' Assumption I: People will protest against the government's decision. Assumption II: The government will get more revenue.", options: ["Only I is implicit", "Only II is implicit", "Both I and II are implicit", "Neither I nor II is implicit"], correctAnswerIndex: 1, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: "एक कथन के बाद दो धारणाएँ दी गई हैं। कथन: 'सरकार ने पेट्रोल और डीजल की कीमत बढ़ाने का फैसला किया है।' धारणा I: लोग सरकार के फैसले का विरोध करेंगे। धारणा II: सरकार को अधिक राजस्व मिलेगा।", options: ["केवल I निहित है", "केवल II निहित है", "I और II दोनों निहित हैं", "न तो I और न ही II निहित है"] } },
    { id: 918, question: "If 'P' means '+', 'Q' means '-', 'R' means '×', and 'S' means '÷', what is the value of the expression: 48 S 12 R 10 P 8 Q 6?", options: ["42", "44", "48", "52"], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC MTS', translation: { question: "यदि 'P' का अर्थ '+', 'Q' का अर्थ '-', 'R' का अर्थ '×', और 'S' का अर्थ '÷' है, तो अभिव्यक्ति का मान क्या है: 48 S 12 R 10 P 8 Q 6?", options: ["42", "44", "48", "52"] } },
    { id: 919, question: "Select the related number from the given alternatives. 6 : 222 :: 7 : ?", options: ["350", "343", "336", "210"], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: "दिए गए विकल्पों में से संबंधित संख्या का चयन करें। 6 : 222 :: 7 : ?", options: ["350", "343", "336", "210"] } },
    { id: 920, question: 'Sunita walks 20 meters towards North. Then she turns right and walks 30 meters. Then she turns right and walks 35 meters. Then she turns left and walks 15 meters. Finally, she turns left and walks 15 meters. In which direction and how many meters is she from the starting position?', options: ['45 meters East', '45 meters West', '30 meters East', '30 meters West'], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: 'सुनीता उत्तर की ओर 20 मीटर चलती है। फिर वह दाएं मुड़ती है और 30 मीटर चलती है। फिर वह दाएं मुड़ती है और 35 मीटर चलती है। फिर वह बाएं मुड़ती है और 15 मीटर चलती है। अंत में, वह बाएं मुड़ती है और 15 मीटर चलती है। वह शुरुआती स्थिति से किस दिशा में और कितने मीटर की दूरी पर है?', options: ['45 मीटर पूर्व', '45 मीटर पश्चिम', '30 मीटर पूर्व', '30 मीटर पश्चिम'] } },
    { id: 921, question: "Find the odd one out from the given alternatives, considering the properties of the numbers.", options: ["144", "169", "196", "210"], correctAnswerIndex: 3, subject: 'Reasoning', exam: 'SSC MTS', translation: { question: 'संख्याओं के गुणों को ध्यान में रखते हुए, दिए गए विकल्पों में से विषम का पता लगाएं।', options: ['144', '169', '196', '210'] } },
    { id: 922, question: "In a code, 'CLEVER' is written as 'BMDUDS'. How is 'STUPID' written in that code? The pattern involves shifting letters backward.", options: ["RSVHQC", "RTTOJC", "RSVНQC", "RSVHPC"], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: "एक कोड में, 'CLEVER' को 'BMDUDS' लिखा जाता है। उस कोड में 'STUPID' कैसे लिखा जाता है? पैटर्न में अक्षरों को पीछे की ओर स्थानांतरित करना शामिल है।", options: ["RSVHQC", "RTTOJC", "RSVНQC", "RSVHPC"] } },
    { id: 923, question: "Anu is Ram's sister. Ram is Neha's brother. Neha is Bina's daughter. How is Bina related to Anu? A puzzle on family relationships.", options: ["Mother", "Sister", "Daughter", "Grandmother"], correctAnswerIndex: 0, subject: 'Reasoning', exam: 'SSC CHSL', translation: { question: "अनु राम की बहन है। राम नेहा का भाई है। नेहा बीना की बेटी है। बीना अनु से कैसे संबंधित है? पारिवारिक रिश्तों पर एक पहेली।", options: ["माँ", "बहन", "बेटी", "दादी"] } },
    { id: 924, question: "If '+' means 'divided by', '−' means 'add', '×' means 'minus' and '÷' means 'multiplied by', then what will be the value of the following expression? [{(17 × 12) − (4 × 2)} + (23 − 6)] ÷ 1", options: ["7", "9", "5", "3"], correctAnswerIndex: 1, subject: 'Reasoning', exam: 'SSC CGL', translation: { question: "यदि '+' का अर्थ 'से विभाजित', '−' का अर्थ 'जोड़', '×' का अर्थ 'घटा' और '÷' का अर्थ 'से गुणा' है, तो निम्नलिखित अभिव्यक्ति का मान क्या होगा? [{(17 × 12) − (4 × 2)} + (23 − 6)] ÷ 1", options: ["7", "9", "5", "3"] } }
  ], 25),
