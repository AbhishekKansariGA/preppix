...
export const staticQuestions: { [key: string]: Question[] } = {
  ...
  'maths-profit-loss': Array.from({ length: 10 }, (_, i) => ({
    id: 200 + i,
    question: 'एक दुकानदार 10% के लाभ पर एक वस्तु 550 रुपये में बेचता है। लागत मूल्य क्या है?',
  ...
  'maths-si-ci': Array.from({ length: 10 }, (_, i) => ({
    id: 400 + i,
    question: '1000 रुपये पर 2 साल के लिए 5% प्रति वर्ष की दर से साधारण ब्याज क्या है?',
  ...
  'maths-di': Array.from({ length: 10 }, (_, i) => ({
    id: 700 + i,
    question: 'पाई चार्ट खर्चों का वितरण दिखाता है। यदि कुल खर्च 1,00,000 रुपये है, तो भोजन (40%) पर खर्च क्या है?',
